...
class LTFModule(pl.LightningModule):
    ...
    def __init__(self, config) -> None:
        ...
        self.model = WtNet(wavelet=config.wavelet, level=config.level, axis=config.axis, in_chn=config.in_chn,
                           hid_chn=config.hid_chn, out_chn=config.out_chn, drop=config.drop, pred_len=config.pred_len,
